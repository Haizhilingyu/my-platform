...
- `OpenAppClientCreateDTO`: clientName `@NotBlank+@Size(100)`，redirectUris/scopes/grantTypes `@NotEmpty`
- `OpenAppClientUpdateDTO`: clientName `@NotBlank+@Size(100)`，enabled `@NotNull`
- 边界测试：`src/test/java/.../dto/OpenAppClientCreateDTOBoundaryTest.java`
