 ...
 *
 * <p>语义：账号因连续登录失败被临时锁定，需管理员解锁或等待锁定窗口过期。与普通 {@link BizException}(401 凭证错误)
 * 区分，便于前端精确提示「账号已锁定，请联系管理员」。
 *
 * <p>状态码 423 来源于 WebDAV 扩展（RFC 4918），语义为「资源被锁定」，契合账号锁定场景。 Spring {@link
 * org.springframework.http.HttpStatus} 已包含 {@code LOCKED(423, "Locked")}。
 */
